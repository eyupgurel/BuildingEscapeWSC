...
unrealRootPath=/home/egl/UnrealEngine
BuildingEscapeWSCRootPath=/home/egl/Documents/Unreal Projects/BuildingEscapeWSC

gameProjectFile=/home/egl/Documents/Unreal Projects/BuildingEscapeWSC/BuildingEscapeWSC.uproject
...
include(BuildingEscapeWSCSource.pri)
include(BuildingEscapeWSCHeader.pri)
include(BuildingEscapeWSCConfig.pri)
include(BuildingEscapeWSCIncludes.pri)
include(BuildingEscapeWSCDefines.pri)

BuildingEscapeWSC-Linux-Debug.commands = $$build BuildingEscapeWSC Linux Debug  -project="\"$$gameProjectFile\"" $$args
BuildingEscapeWSC-Linux-DebugGame.commands = $$build BuildingEscapeWSC Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BuildingEscapeWSC-Linux-Shipping.commands = $$build BuildingEscapeWSC Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BuildingEscapeWSC-Linux-Test.commands = $$build BuildingEscapeWSC Linux Test  -project="\"$$gameProjectFile\"" $$args
BuildingEscapeWSC.commands = $$build BuildingEscapeWSC Linux Development  -project="\"$$gameProjectFile\"" $$args

BuildingEscapeWSCEditor-Linux-Debug.commands = $$build BuildingEscapeWSCEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BuildingEscapeWSCEditor-Linux-DebugGame.commands = $$build BuildingEscapeWSCEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BuildingEscapeWSCEditor-Linux-Shipping.commands = $$build BuildingEscapeWSCEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BuildingEscapeWSCEditor-Linux-Test.commands = $$build BuildingEscapeWSCEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BuildingEscapeWSCEditor.commands = $$build BuildingEscapeWSCEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	BuildingEscapeWSC-Linux-Debug \
	BuildingEscapeWSC-Linux-DebugGame \
	BuildingEscapeWSC-Linux-Shipping \
	BuildingEscapeWSC-Linux-Test \
	BuildingEscapeWSC \
	BuildingEscapeWSCEditor-Linux-Debug \
	BuildingEscapeWSCEditor-Linux-DebugGame \
	BuildingEscapeWSCEditor-Linux-Shipping \
	BuildingEscapeWSCEditor-Linux-Test \
	BuildingEscapeWSCEditor \

...
BuildingEscapeWSC-Linux-Debug:
	 $(PROJECTBUILD) BuildingEscapeWSC Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSC-Linux-DebugGame:
	 $(PROJECTBUILD) BuildingEscapeWSC Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSC-Linux-Shipping:
	 $(PROJECTBUILD) BuildingEscapeWSC Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSC-Linux-Test:
	 $(PROJECTBUILD) BuildingEscapeWSC Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSC:
	 $(PROJECTBUILD) BuildingEscapeWSC Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSCEditor-Linux-Debug:
	 $(PROJECTBUILD) BuildingEscapeWSCEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSCEditor-Linux-DebugGame:
	 $(PROJECTBUILD) BuildingEscapeWSCEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSCEditor-Linux-Shipping:
	 $(PROJECTBUILD) BuildingEscapeWSCEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSCEditor-Linux-Test:
	 $(PROJECTBUILD) BuildingEscapeWSCEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingEscapeWSCEditor:
	 $(PROJECTBUILD) BuildingEscapeWSCEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
